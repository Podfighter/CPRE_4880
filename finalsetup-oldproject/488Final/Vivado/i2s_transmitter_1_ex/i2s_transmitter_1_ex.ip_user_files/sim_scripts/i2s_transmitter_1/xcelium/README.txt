...
#
# Generated by export_simulation on Tue Apr 28 18:06:50 -0500 2026
#
################################################################################
...
'-reset_run' switch to the './i2s_transmitter_1.sh' script.

./i2s_transmitter_1.sh -reset_run
...
./i2s_transmitter_1.sh -noclean_files

For more information on the script, please type './i2s_transmitter_1.sh -help'.
