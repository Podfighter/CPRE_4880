...
#
# Generated by export_simulation on Tue Apr 28 14:50:54 -0500 2026
#
################################################################################
...
'-reset_run' switch to the './i2s_transmitter_0.sh' script.

./i2s_transmitter_0.sh -reset_run
...
./i2s_transmitter_0.sh -noclean_files

For more information on the script, please type './i2s_transmitter_0.sh -help'.
