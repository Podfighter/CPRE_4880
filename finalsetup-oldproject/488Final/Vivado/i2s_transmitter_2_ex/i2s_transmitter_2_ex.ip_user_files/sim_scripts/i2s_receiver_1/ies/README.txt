...
'-reset_run' switch to the './i2s_receiver_1.sh' script.

./i2s_receiver_1.sh -reset_run
...
./i2s_receiver_1.sh -noclean_files

For more information on the script, please type './i2s_receiver_1.sh -help'.
