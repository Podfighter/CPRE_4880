...
#
# Generated by export_simulation on Wed Apr 29 22:53:06 -0500 2026
#
################################################################################
...
'-reset_run' switch to the './i2s_transmitter_2.sh' script.

./i2s_transmitter_2.sh -reset_run
...
./i2s_transmitter_2.sh -noclean_files

For more information on the script, please type './i2s_transmitter_2.sh -help'.
