...
HD_PWD='X:/cpre488/Labs/MP-0/MP-0/MP-0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MP0_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MP0_wrapper.tcl
