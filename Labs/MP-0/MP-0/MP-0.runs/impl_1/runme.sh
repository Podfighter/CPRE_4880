...
HD_PWD='X:/cpre488/Labs/MP-0/MP-0/MP-0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MP0_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MP0_wrapper.tcl -notrace
