...
################################################################
# This is a generated script based on design: bd_9b5a
#
...
proc create_root_design { parentCell } {
  ...
  set SLOT_1_GPIO [ create_bd_intf_port -mode Monitor -vlnv xilinx.com:interface:gpio_rtl:1.0 SLOT_1_GPIO ]
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {SLOT_0_AXI:SLOT_3_AXIS} \
...
connect_bd_intf_net -intf_net Conn1 [get_bd_intf_ports SLOT_3_AXIS] [get_bd_intf_pins g_inst/slot_1_axis]

  # Create port connections
  connect_bd_net -net SLOT_1_GPIO_tri_o_1 [get_bd_ports SLOT_1_GPIO_tri_o] [get_bd_pins ila_lib/probe19]
  connect_bd_net -net SLOT_2_VIDEO_TIMING_active_video_1 [get_bd_ports SLOT_2_VIDEO_TIMING_active_video] [get_bd_pins ila_lib/probe20]
  connect_bd_net -net SLOT_2_VIDEO_TIMING_hblank_1 [get_bd_ports SLOT_2_VIDEO_TIMING_hblank] [get_bd_pins ila_lib/probe21]
  connect_bd_net -net SLOT_2_VIDEO_TIMING_hsync_1 [get_bd_ports SLOT_2_VIDEO_TIMING_hsync] [get_bd_pins ila_lib/probe22]
  connect_bd_net -net SLOT_2_VIDEO_TIMING_vblank_1 [get_bd_ports SLOT_2_VIDEO_TIMING_vblank] [get_bd_pins ila_lib/probe23]
  connect_bd_net -net SLOT_2_VIDEO_TIMING_vsync_1 [get_bd_ports SLOT_2_VIDEO_TIMING_vsync] [get_bd_pins ila_lib/probe24]
  ...
  connect_bd_net -net net_slot_0_axi_arprot [get_bd_pins g_inst/m_slot_0_axi_arprot] [get_bd_pins ila_lib/probe3]
  ...
  connect_bd_net -net net_slot_0_axi_awprot [get_bd_pins g_inst/m_slot_0_axi_awprot] [get_bd_pins ila_lib/probe6]
  ...
  connect_bd_net -net net_slot_0_axi_b_cnt [get_bd_pins g_inst/m_slot_0_axi_b_cnt] [get_bd_pins ila_lib/probe7]
  ...
  connect_bd_net -net net_slot_0_axi_bresp [get_bd_pins g_inst/m_slot_0_axi_bresp] [get_bd_pins ila_lib/probe8]
  connect_bd_net -net net_slot_0_axi_bvalid [get_bd_pins g_inst/m_slot_0_axi_bvalid] [get_bd_pins slot_0_b/In0]
  connect_bd_net -net net_slot_0_axi_r_cnt [get_bd_pins g_inst/m_slot_0_axi_r_cnt] [get_bd_pins ila_lib/probe9]
  connect_bd_net -net net_slot_0_axi_r_ctrl [get_bd_pins ila_lib/probe18] [get_bd_pins slot_0_r/dout]
  connect_bd_net -net net_slot_0_axi_rdata [get_bd_pins g_inst/m_slot_0_axi_rdata] [get_bd_pins ila_lib/probe10]
  connect_bd_net -net net_slot_0_axi_rready [get_bd_pins g_inst/m_slot_0_axi_rready] [get_bd_pins slot_0_r/In1]
  connect_bd_net -net net_slot_0_axi_rresp [get_bd_pins g_inst/m_slot_0_axi_rresp] [get_bd_pins ila_lib/probe11]
  ...
  connect_bd_net -net net_slot_3_axis_tdata [get_bd_pins g_inst/m_slot_1_axis_tdata] [get_bd_pins ila_lib/probe25]
  connect_bd_net -net net_slot_3_axis_tkeep [get_bd_pins g_inst/m_slot_1_axis_tkeep] [get_bd_pins ila_lib/probe26]
  connect_bd_net -net net_slot_3_axis_tlast [get_bd_pins g_inst/m_slot_1_axis_tlast] [get_bd_pins ila_lib/probe30]
  connect_bd_net -net net_slot_3_axis_tready [get_bd_pins g_inst/m_slot_1_axis_tready] [get_bd_pins ila_lib/probe29]
  connect_bd_net -net net_slot_3_axis_tuser [get_bd_pins g_inst/m_slot_1_axis_tuser] [get_bd_pins ila_lib/probe27]
  connect_bd_net -net net_slot_3_axis_tvalid [get_bd_pins g_inst/m_slot_1_axis_tvalid] [get_bd_pins ila_lib/probe28]
