...
fpga -file X:/cpre488/Labs/MP-0/vitus/MP0/_ide/bitstream/MP0_wrapper.bit
targets -set -nocase -filter {name =~"APU*"}
...
targets -set -nocase -filter {name =~"APU*"}
source X:/cpre488/Labs/MP-0/vitus/MP0/_ide/psinit/ps7_init.tcl
ps7_init
ps7_post_config
targets -set -nocase -filter {name =~ "*A9*#0"}
dow X:/cpre488/Labs/MP-0/vitus/MP0/Debug/MP0.elf
