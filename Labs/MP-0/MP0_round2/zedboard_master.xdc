...
# JC Pmod - Bank 13
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN AB6 [get_ports {JC1_N}];  # "JC1_N"  "Virtual Switch 7"
#set_property PACKAGE_PIN AB7 [get_ports {JC1_P}];  # "JC1_P"  "Virtual Switch 6"
#set_property PACKAGE_PIN AA4 [get_ports {JC2_N}];  # "JC2_N"  "Virtual Switch 5"
#set_property PACKAGE_PIN Y4  [get_ports {JC2_P}];  # "JC2_P"  "Virtual Switch 4"
#set_property PACKAGE_PIN T6  [get_ports {JC3_N}];  # "JC3_N"  "Virtual Switch 3"  
#set_property PACKAGE_PIN R6  [get_ports {JC3_P}];  # "JC3_P"  "Virtual Switch 2"
#set_property PACKAGE_PIN U4  [get_ports {JC4_N}];  # "JC4_N"  "Virtual Switch 1"
#set_property PACKAGE_PIN T4  [get_ports {JC4_P}];  # "JC4_P"  "Virtual Switch 0"

# ----------------------------------------------------------------------------
# JD Pmod - Bank 13
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN W7 [get_ports {JD1_N}];  # "JD1_N"   "Virtual Button Up"
#set_property PACKAGE_PIN V7 [get_ports {JD1_P}];  # "JD1_P"   "Virtual Button Down"
#set_property PACKAGE_PIN V4 [get_ports {JD2_N}];  # "JD2_N"   "Virtual Button Right"
#set_property PACKAGE_PIN V5 [get_ports {JD2_P}];  # "JD2_P"   "Virtual Button Left"
#set_property PACKAGE_PIN W5 [get_ports {JD3_N}];  # "JD3_N"   "Virtual Button Center"
...
set_property PACKAGE_PIN Y20  [get_ports {VGA[1]}];  # "VGA-B2"
set_property PACKAGE_PIN AB20 [get_ports {VGA[2]}];  # "VGA-B3"
set_property PACKAGE_PIN AB19 [get_ports {VGA[3]}];  # "VGA-B4"
set_property PACKAGE_PIN AB22 [get_ports {VGA[4]}];  # "VGA-G1"
set_property PACKAGE_PIN AA22 [get_ports {VGA[5]}];  # "VGA-G2"
set_property PACKAGE_PIN AB21 [get_ports {VGA[6]}];  # "VGA-G3"
set_property PACKAGE_PIN AA21 [get_ports {VGA[7]}];  # "VGA-G4"
set_property PACKAGE_PIN AA19 [get_ports {VGA_HS}];  # "VGA-HS"
set_property PACKAGE_PIN V20  [get_ports {VGA[8]}];  # "VGA-R1"
set_property PACKAGE_PIN U20  [get_ports {VGA[9]}];  # "VGA-R2"
set_property PACKAGE_PIN V19  [get_ports {VGA[10]}];  # "VGA-R3"
set_property PACKAGE_PIN V18  [get_ports {VGA[11]}];  # "VGA-R4"
