...
HD_PWD='X:/cpre488/Labs/MP-0/MP0_round2/MP0_round2.runs/design_1_rst_design_1_25M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rst_design_1_25M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rst_design_1_25M_0.tcl
