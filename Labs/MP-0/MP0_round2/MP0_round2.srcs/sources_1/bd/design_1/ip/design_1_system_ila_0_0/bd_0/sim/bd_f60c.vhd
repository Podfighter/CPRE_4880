...
architecture STRUCTURE of bd_f60c is
  ...
  signal SLOT_1_VIDEO_TIMING_active_video_1 : STD_LOGIC;
  signal SLOT_1_VIDEO_TIMING_hblank_1 : STD_LOGIC;
  signal SLOT_1_VIDEO_TIMING_hsync_1 : STD_LOGIC;
  signal SLOT_1_VIDEO_TIMING_vblank_1 : STD_LOGIC;
  signal SLOT_1_VIDEO_TIMING_vsync_1 : STD_LOGIC;
  ...
  attribute X_INTERFACE_INFO of SLOT_1_VIDEO_TIMING_active_video : signal is "xilinx.com:interface:video_timing:2.0 SLOT_1_VIDEO_TIMING ACTIVE_VIDEO";
  attribute X_INTERFACE_INFO of SLOT_1_VIDEO_TIMING_hblank : signal is "xilinx.com:interface:video_timing:2.0 SLOT_1_VIDEO_TIMING HBLANK";
  attribute X_INTERFACE_INFO of SLOT_1_VIDEO_TIMING_hsync : signal is "xilinx.com:interface:video_timing:2.0 SLOT_1_VIDEO_TIMING HSYNC";
  attribute X_INTERFACE_INFO of SLOT_1_VIDEO_TIMING_vblank : signal is "xilinx.com:interface:video_timing:2.0 SLOT_1_VIDEO_TIMING VBLANK";
  attribute X_INTERFACE_INFO of SLOT_1_VIDEO_TIMING_vsync : signal is "xilinx.com:interface:video_timing:2.0 SLOT_1_VIDEO_TIMING VSYNC";
  attribute X_INTERFACE_INFO of clk : signal is "xilinx.com:signal:clock:1.0 CLK.CLK CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXIS, ASSOCIATED_RESET resetn, CLK_DOMAIN design_1_processing_system7_0_0_FCLK_CLK0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000";
  attribute X_INTERFACE_INFO of resetn : signal is "xilinx.com:signal:reset:1.0 RST.RESETN RST";
  attribute X_INTERFACE_PARAMETER of resetn : signal is "XIL_INTERFACENAME RST.RESETN, INSERT_VIP 0, POLARITY ACTIVE_LOW";
  attribute X_INTERFACE_INFO of SLOT_0_AXIS_tdata : signal is "xilinx.com:interface:axis:1.0 SLOT_0_AXIS TDATA";
  attribute X_INTERFACE_PARAMETER of SLOT_0_AXIS_tdata : signal is "XIL_INTERFACENAME SLOT_0_AXIS, CLK_DOMAIN design_1_processing_system7_0_0_FCLK_CLK0, FREQ_HZ 100000000, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 1, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 1";
...
begin
  ...
  SLOT_1_VIDEO_TIMING_active_video_1 <= SLOT_1_VIDEO_TIMING_active_video;
  SLOT_1_VIDEO_TIMING_hblank_1 <= SLOT_1_VIDEO_TIMING_hblank;
  SLOT_1_VIDEO_TIMING_hsync_1 <= SLOT_1_VIDEO_TIMING_hsync;
  SLOT_1_VIDEO_TIMING_vblank_1 <= SLOT_1_VIDEO_TIMING_vblank;
  SLOT_1_VIDEO_TIMING_vsync_1 <= SLOT_1_VIDEO_TIMING_vsync;
  clk_1 <= clk;
  resetn_1 <= resetn;
...
ila_lib: component bd_f60c_ila_lib_0
     port map (
      ...
      probe10(0) => SLOT_1_VIDEO_TIMING_vsync_1,
      ...
      probe6(0) => SLOT_1_VIDEO_TIMING_active_video_1,
      probe7(0) => SLOT_1_VIDEO_TIMING_hblank_1,
      probe8(0) => SLOT_1_VIDEO_TIMING_hsync_1,
      probe9(0) => SLOT_1_VIDEO_TIMING_vblank_1
    );
end STRUCTURE;
