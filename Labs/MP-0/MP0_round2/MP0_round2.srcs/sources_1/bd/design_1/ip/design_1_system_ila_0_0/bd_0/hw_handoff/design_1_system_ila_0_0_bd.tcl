...
proc create_root_design { parentCell } {
  ...
  set SLOT_1_VIDEO_TIMING [ create_bd_intf_port -mode Monitor -vlnv xilinx.com:interface:video_timing_rtl:2.0 SLOT_1_VIDEO_TIMING ]
...
connect_bd_intf_net -intf_net Conn [get_bd_intf_ports SLOT_0_AXIS] [get_bd_intf_pins g_inst/slot_0_axis]
  ...
  connect_bd_net -net SLOT_1_VIDEO_TIMING_active_video_1 [get_bd_ports SLOT_1_VIDEO_TIMING_active_video] [get_bd_pins ila_lib/probe6]
  connect_bd_net -net SLOT_1_VIDEO_TIMING_hblank_1 [get_bd_ports SLOT_1_VIDEO_TIMING_hblank] [get_bd_pins ila_lib/probe7]
  connect_bd_net -net SLOT_1_VIDEO_TIMING_hsync_1 [get_bd_ports SLOT_1_VIDEO_TIMING_hsync] [get_bd_pins ila_lib/probe8]
  connect_bd_net -net SLOT_1_VIDEO_TIMING_vblank_1 [get_bd_ports SLOT_1_VIDEO_TIMING_vblank] [get_bd_pins ila_lib/probe9]
  connect_bd_net -net SLOT_1_VIDEO_TIMING_vsync_1 [get_bd_ports SLOT_1_VIDEO_TIMING_vsync] [get_bd_pins ila_lib/probe10]
