...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = axi_cama_bta
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.6
 PARAMETER HW_INSTANCE = axi_cama_gpio
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = axi_vdma_a
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = vprocss
 PARAMETER DRIVER_VER = 2.7
 PARAMETER HW_INSTANCE = v_proc_ss_1
END
