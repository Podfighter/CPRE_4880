...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.TDATA_REMAP {8'b10000000,tdata[9:2]} \
  ...
  connect_bd_intf_net -intf_net axis_subset_converter_0_M_AXIS [get_bd_intf_pins axi_vdma_a/S_AXIS_S2MM] [get_bd_intf_pins axis_subset_converter_0/M_AXIS]
