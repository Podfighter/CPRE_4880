...
----------------------------------------------------------------------------------
--Command: generate_target bd_ed91.bd
--Design : bd_ed91
...
entity bd_ed91 is
  ...
  attribute CORE_GENERATION_INFO of bd_ed91 : entity is "bd_ed91,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_ed91,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of bd_ed91 : entity is "system_v_proc_ss_0_1.hwdef";
end bd_ed91;

architecture STRUCTURE of bd_ed91 is
  component bd_ed91_csc_0 is
  port (
    s_axi_CTRL_AWADDR : in STD_LOGIC_VECTOR ( 8 downto 0 );
    s_axi_CTRL_AWVALID : in STD_LOGIC;
    s_axi_CTRL_AWREADY : out STD_LOGIC;
  ...
  end component bd_ed91_csc_0;
  signal intf_net_bdry_in_s_axi_ctrl_ARADDR : STD_LOGIC_VECTOR ( 8 downto 0 );
  signal intf_net_bdry_in_s_axi_ctrl_ARREADY : STD_LOGIC;
  signal intf_net_bdry_in_s_axi_ctrl_ARVALID : STD_LOGIC;
  signal intf_net_bdry_in_s_axi_ctrl_AWADDR : STD_LOGIC_VECTOR ( 8 downto 0 );
...
begin
  intf_net_bdry_in_s_axi_ctrl_ARADDR(8 downto 0) <= s_axi_ctrl_araddr(8 downto 0);
  intf_net_bdry_in_s_axi_ctrl_ARVALID <= s_axi_ctrl_arvalid;
  intf_net_bdry_in_s_axi_ctrl_AWADDR(8 downto 0) <= s_axi_ctrl_awaddr(8 downto 0);
...
csc: component bd_ed91_csc_0
     port map (
      ...
      s_axi_CTRL_ARADDR(8 downto 0) => intf_net_bdry_in_s_axi_ctrl_ARADDR(8 downto 0),
      s_axi_CTRL_ARREADY => intf_net_bdry_in_s_axi_ctrl_ARREADY,
      s_axi_CTRL_ARVALID => intf_net_bdry_in_s_axi_ctrl_ARVALID,
      s_axi_CTRL_AWADDR(8 downto 0) => intf_net_bdry_in_s_axi_ctrl_AWADDR(8 downto 0),
      s_axi_CTRL_AWREADY => intf_net_bdry_in_s_axi_ctrl_AWREADY,
