...
----------------------------------------------------------------------------------
--Command: generate_target bd_ed01_wrapper.bd
--Design : bd_ed01_wrapper
...
architecture STRUCTURE of bd_ed01_wrapper is
  component bd_ed01 is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    s_axis_tdata : in STD_LOGIC_VECTOR ( 23 downto 0 );
  ...
  end component bd_ed01;
begin
bd_ed01_i: component bd_ed01
     port map (
      aclk => aclk,
      aresetn => aresetn,
