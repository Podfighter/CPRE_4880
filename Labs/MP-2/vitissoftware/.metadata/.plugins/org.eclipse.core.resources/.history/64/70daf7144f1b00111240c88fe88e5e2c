...
static inline Xuint16 rgb2chroma(Xuint32 Red, Xuint32 Green, Xuint32 Blue, int index){
	//clean it up later
	Xuint8 Y = 0.183*Red + 0.614*Green + 0.062*Blue + 16;
	Xuint8 Cb = (-0.101*Red -0.338*Green + 0.439*Blue + 128)*(!(index % 2));
	Xuint8 Cr = (0.439*Red -0.399*Green - 0.040*Blue + 128)*((index % 2));


return ((Xuint16)Y | ((Xuint16)(Cb | Cr) << 8));
}
