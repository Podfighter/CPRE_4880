...
//   XVprocSs_Start(&proc_ss_RGB_YCrCb_444);
   ...
   //   Xil_Out32((XPAR_XV_DEMOSAIC_0_S_AXI_CTRL_BASEADDR) + (XV_DEMOSAIC), (u32)(0x81));
   //   //set width to 1920
   //   Xil_Out32((XPAR_XV_DEMOSAIC_0_S_AXI_CTRL_BASEADDR) + (XV_DEMOSAIC_CTRL_ADDR_AP_CT), (u32)(0x81));
   //   //set height to 1080
   //   Xil_Out32((XPAR_XV_DEMOSAIC_0_S_AXI_CTRL_BASEADDR) + (XV_DEMOSAIC_CTRL_ADDR_AP_CTRL), (u32)(0x81));
   //   //set phase to BGGR.
   //
