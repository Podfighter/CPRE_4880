...
//
//		case 1:
//			for (int row = 0; row < 1080; row + 2) {
//						 		  for(int col = 0;col < 1920;col + 2){
//
//						 			  //grab vals
//						 			  buf[row][col] = pS2MM_Mem[row*1920 + col];
//						 			 buf[row][col + 1] = pS2MM_Mem[row*1920 + col];
//						 			buf[row + 1][col] = pS2MM_Mem[row*1920 + col];
//						 			buf[row + 1][col + 1] = pS2MM_Mem[row*1920 + col];
//						 		  }
//						  }
//
//
			...
			//record it
			  for (int row = 0; row < 1080; row++) {
			 		  for(int col = 0;col < 1920;col++){
			 			  ...
			 			  //grab vals
			 			  snapshot[index][row][col] = pS2MM_Mem[row*1920 + col];
			 		  }
			  }
