...
set_property PACKAGE_PIN AA6 [get_ports {BCLK_I}];  # "AC-GPIO2"
set_property PACKAGE_PIN Y6  [get_ports {LRCLK_I}];  # "AC-GPIO3"
set_property PACKAGE_PIN AB2 [get_ports {MCLK_O}];  # "AC-MCLK"


set_property PACKAGE_PIN AB4 [get_ports {IIC_0_0_scl_io}];  # "AC-SCK"
set_property PACKAGE_PIN AB5 [get_ports {IIC_0_0_sda_io}];  # "AC-SDA"
...
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {MCLK_DA}];  # "JA1" MCLK_DA
set_property PACKAGE_PIN AA11 [get_ports {LRCK_DA}];  # "JA2" LRCK_DA
set_property PACKAGE_PIN Y10  [get_ports {SCLK_DA}];  # "JA3" SCLK_DA
set_property PACKAGE_PIN AA9  [get_ports {SDOUT_DA}];  # "JA4" SDOUT_DA
set_property PACKAGE_PIN AB11 [get_ports {MCLK_AD}];  # "JA7" MCLK_AD
set_property PACKAGE_PIN AB10 [get_ports {LRCK_AD}];  # "JA8" LRCK_AD
set_property PACKAGE_PIN AB9  [get_ports {SCLK_AD}];  # "JA9" SCLK_AD
set_property PACKAGE_PIN AA8  [get_ports {SDIN_AD}];  # "JA10" SDIN_AD


# ----------------------------------------------------------------------------
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W12 [get_ports {MCLK_DA2}];  # "JB1"   MCLK_DA
set_property PACKAGE_PIN W11 [get_ports {LRCK_DA2}];  # "JB2"   LRCK_DA
set_property PACKAGE_PIN V10 [get_ports {SCLK_DA2}];  # "JB3"   SCLK_DA
set_property PACKAGE_PIN W8 [get_ports {SDOUT_DA2}];  # "JB4"    SDOUT_DA
set_property PACKAGE_PIN V12 [get_ports {MCLK_AD2}];  # "JB7"   MCLK_AD
set_property PACKAGE_PIN W10 [get_ports {LRCK_AD2}];  # "JB8"   LRCK_AD
set_property PACKAGE_PIN V9 [get_ports {SCLK_AD2}];  # "JB9"    SCLK_AD
set_property PACKAGE_PIN V8 [get_ports {SDIN_AD2}];  # "JB10"  SDIN_AD
