...
HD_PWD='C:/Users/ianrun75/Downloads/MP1new/ip_repo/axi_ppm_1.0/axi_ppm_v1_0_project/axi_ppm_v1_0_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_ppm_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source axi_ppm_v1_0.tcl -notrace
