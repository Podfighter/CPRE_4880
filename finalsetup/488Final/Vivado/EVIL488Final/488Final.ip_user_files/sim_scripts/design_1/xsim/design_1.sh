...
xvlog_opts="--relax -L i2s_receiver_v1_0_4 -L i2s_transmitter_v1_0_4 -L axi_vip_v1_1_7 -L processing_system7_vip_v1_0_9 -L xilinx_vip"
xvhdl_opts="--relax"
