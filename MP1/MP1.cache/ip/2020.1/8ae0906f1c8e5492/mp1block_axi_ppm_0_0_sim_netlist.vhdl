...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ppm_capture is
  ...
  signal \channel_buf[1][2]_i_2_n_0\ : STD_LOGIC;
  signal \channel_buf[1][2]_i_3_n_0\ : STD_LOGIC;
  signal \channel_buf[1][2]_i_4_n_0\ : STD_LOGIC;
  signal \channel_buf[1][2]_i_5_n_0\ : STD_LOGIC;
  ...
  signal \channel_buf[1][8]_i_2_n_0\ : STD_LOGIC;
  signal \channel_buf[1][8]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state[1]_i_3__0\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \FSM_sequential_state[1]_i_4__0\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \ch_index[2]_i_4\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \channel_buf[1][0]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \channel_buf[1][10]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \channel_buf[1][11]_i_1\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \channel_buf[1][14]_i_1\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \channel_buf[1][16]_i_4\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \channel_buf[1][16]_i_5\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \channel_buf[1][17]_i_4\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \channel_buf[1][1]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \channel_buf[1][2]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \channel_buf[1][3]_i_1\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \channel_buf[1][8]_i_3\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \channel_buf[1][9]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \dest[2]_i_1\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of fault_i_i_2 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \output_regs[1][17]_i_2\ : label is "soft_lutpair0";
...
\channel_buf[1][16]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \channel_buf[1][2]_i_3_n_0\,
      I2 => \channel_buf[1][16]_i_5_n_0\,
...
\channel_buf[1][17]_i_3\: unisim.vcomponents.LUT5
    generic map(
      ...
      I3 => \timer_count_reg_n_0_[16]\,
      I4 => \channel_buf[1][17]_i_6_n_0\,
      O => \channel_buf[1][17]_i_3_n_0\
    );
\channel_buf[1][17]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\channel_buf[1][17]_i_5\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \channel_buf[1][17]_i_7_n_0\,
      I5 => \channel_buf[1][17]_i_8_n_0\,
      O => \channel_buf[1][17]_i_5_n_0\
    );
\channel_buf[1][17]_i_6\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\channel_buf[1][17]_i_8\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EA"
    )
        port map (
...
\channel_buf[1][2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"BA"
        ...
        port map (
      I0 => \channel_buf[1][2]_i_2_n_0\,
      I1 => \channel_buf[1][16]_i_2_n_0\,
      I2 => \timer_count_reg_n_0_[2]\,
      O => \channel_buf[1][2]_i_1_n_0\
    );
\channel_buf[1][2]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"000000AB"
    )
        port map (
      I0 => \channel_buf[1][2]_i_3_n_0\,
      I1 => \timer_count_reg_n_0_[2]\,
      I2 => \timer_count_reg_n_0_[3]\,
      I3 => \channel_buf[1][2]_i_4_n_0\,
      I4 => \channel_buf[1][2]_i_5_n_0\,
      O => \channel_buf[1][2]_i_2_n_0\
    );
\channel_buf[1][2]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
      ...
      O => \channel_buf[1][2]_i_3_n_0\
    );
\channel_buf[1][2]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
      ...
      I5 => \timer_count_reg_n_0_[11]\,
      O => \channel_buf[1][2]_i_4_n_0\
    );
\channel_buf[1][2]_i_5\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
...
\channel_buf[1][8]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFF8A88"
    )
        port map (
      I0 => \timer_count_reg_n_0_[17]\,
      I1 => \channel_buf[1][8]_i_3_n_0\,
      I2 => \channel_buf[1][16]_i_3_n_0\,
      I3 => \timer_count_reg_n_0_[14]\,
      I4 => \channel_buf[1][17]_i_6_n_0\,
      I5 => \channel_buf[1][2]_i_2_n_0\,
      O => \channel_buf[1][8]_i_2_n_0\
    );
\channel_buf[1][8]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\dest[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFCF0040"
    )
        port map (
...
\dest[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFAF0020"
    )
        port map (
...
fault_i_i_2: unisim.vcomponents.LUT3
    generic map(
      ...
      I0 => \ch_index__0\(2),
      I1 => \ch_index__0\(1),
      I2 => \channel_buf[1][8]_i_2_n_0\,
      O => fault_i_i_2_n_0
    );
fault_i_i_3: unisim.vcomponents.LUT6
    generic map(
      INIT => X"4440404011111111"
    )
        port map (
      I0 => fault_i_i_4_n_0,
      I1 => \channel_buf[1][17]_i_3_n_0\,
...
\output_regs[1][17]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => \ch_index__0\(0),
      I2 => \ch_index__0\(2),
      I3 => \output_regs[1][17]_i_2_n_0\,
      I4 => \channel_buf[1][17]_i_3_n_0\,
      O => \output_regs[1][17]_i_1_n_0\
    );
\output_regs[1][17]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFBFFFF"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ppm_generate is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_1__0\ : label is "soft_lutpair16";
  attribute FSM_ENCODED_STATES : string;
  ...
  attribute SOFT_HLUTNM of \timer[0]_i_1\ : label is "soft_lutpair16";
begin
