...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ppm_capture is
  ...
  signal fault_i13_in : STD_LOGIC;
  signal fault_i18_out : STD_LOGIC;
  ...
  signal fault_i_i_9_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \ch_index[1]_i_2\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \channel_buf[1][10]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \channel_buf[1][11]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \channel_buf[1][12]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \channel_buf[1][13]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \channel_buf[1][15]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \channel_buf[1][16]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \channel_buf[1][17]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \channel_buf[1][18]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \channel_buf[1][19]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \channel_buf[1][1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \channel_buf[1][20]_i_2\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of \channel_buf[1][5]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \channel_buf[1][6]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \channel_buf[1][7]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \channel_buf[1][8]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \channel_buf[1][9]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \dest[0]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of falling_edge_i_i_1 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of fault_i_i_2 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of fault_i_i_3 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of fault_i_i_5 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \filter_ctr[0]_i_1\ : label is "soft_lutpair18";
  ...
  attribute SOFT_HLUTNM of ppm_clean_i_2 : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of rising_edge_i_i_1 : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \timer_i[0]_i_11\ : label is "soft_lutpair19";
...
\ch_index[2]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\channel_buf[1][0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I2 => \channel_buf[1][20]_i_4_n_0\,
      I3 => timer_i_reg(0),
      O => \channel_buf[1][0]_i_1_n_0\
    );
\channel_buf[1][10]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0100"
    )
        port map (
...
\channel_buf[1][11]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"E0"
        ...
        port map (
      I0 => timer_i_reg(11),
      I1 => \channel_buf[1][20]_i_4_n_0\,
      I2 => \channel_buf[1][17]_i_2_n_0\,
...
\channel_buf[1][13]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0100"
    )
        port map (
...
\channel_buf[1][17]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"E0"
    )
        port map (
...
\channel_buf[1][20]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\channel_buf[1][20]_i_7\: unisim.vcomponents.LUT6
    generic map(
...
\dest[0]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000020"
    )
        port map (
...
fault_i_i_5: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0400"
    )
        port map (
...
fault_i_i_6: unisim.vcomponents.LUT6
    generic map(
...
fault_i_i_8: unisim.vcomponents.LUT6
    generic map(
...
fault_i_i_9: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
