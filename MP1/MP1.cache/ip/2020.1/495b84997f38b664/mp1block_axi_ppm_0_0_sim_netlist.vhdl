...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ppm_capture is
  port (
    ...
    \output_regs_reg[1][17]_0\ : out STD_LOGIC_VECTOR ( 17 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ppm_capture is
  ...
  signal \channel_buf_reg[0]_0\ : STD_LOGIC_VECTOR ( 17 downto 0 );
  signal \channel_buf_reg[1]_1\ : STD_LOGIC_VECTOR ( 17 downto 0 );
  signal \channel_buf_reg[2]_2\ : STD_LOGIC_VECTOR ( 17 downto 0 );
  signal \channel_buf_reg[3]_3\ : STD_LOGIC_VECTOR ( 17 downto 0 );
  signal \channel_buf_reg[4]_4\ : STD_LOGIC_VECTOR ( 17 downto 0 );
  signal \channel_buf_reg[5]_5\ : STD_LOGIC_VECTOR ( 17 downto 0 );
  ...
  signal \output_regs[0][17]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state[1]_i_6__0\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \ch_index[2]_i_4\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \channel_buf[0][0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \channel_buf[0][10]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \channel_buf[0][11]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \channel_buf[0][12]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \channel_buf[0][13]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \channel_buf[0][14]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \channel_buf[0][15]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \channel_buf[0][16]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \channel_buf[0][17]_i_3\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \channel_buf[0][1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \channel_buf[0][2]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \channel_buf[0][3]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \channel_buf[0][4]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \channel_buf[0][5]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \channel_buf[0][6]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \channel_buf[0][7]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \channel_buf[0][8]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \channel_buf[0][9]_i_1\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \filter_ctr[4]_i_2\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of ppm_clean_i_2 : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of timer_of_i_1 : label is "soft_lutpair3";
begin
  SR(0) <= \^sr\(0);
...
\FSM_sequential_state[1]_i_6__0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\ch_index[2]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"2A"
    )
        port map (
...
\channel_buf[0][11]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\channel_buf[0][14]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\channel_buf[0][15]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\channel_buf[0][17]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"10000001"
    )
        port map (
      I0 => \ch_index__0\(0),
      I1 => \channel_buf[0][17]_i_3_n_0\,
      I2 => \FSM_sequential_state[1]_i_3__0_n_0\,
      I3 => \ch_index__0\(2),
      I4 => \ch_index__0\(1),
      O => \channel_buf[0][17]_i_1_n_0\
    );
\channel_buf[0][17]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\channel_buf[0][17]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFBFFFF"
    )
        port map (
...
\channel_buf[0][4]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\channel_buf[0][5]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\channel_buf[0][6]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\channel_buf[0][7]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\channel_buf[0][8]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\channel_buf[0][9]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\channel_buf_reg[0][0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => s00_axi_aclk,
      CE => \channel_buf[0][17]_i_1_n_0\,
      D => \channel_buf[0][0]_i_1_n_0\,
      Q => \channel_buf_reg[0]_0\(0),
      R => \^sr\(0)
    );
...
\channel_buf_reg[0][17]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => s00_axi_aclk,
      CE => \channel_buf[0][17]_i_1_n_0\,
      D => \channel_buf[0][17]_i_2_n_0\,
      Q => \channel_buf_reg[0]_0\(17),
      R => \^sr\(0)
    );
...
\output_regs[0][17]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00200000"
    )
        port map (
...
\output_regs_reg[0][0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => s00_axi_aclk,
      CE => \output_regs[0][17]_i_1_n_0\,
      D => \channel_buf_reg[0]_0\(0),
      Q => Q(0),
      R => \^sr\(0)
    );
...
\output_regs_reg[1][0]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => s00_axi_aclk,
      CE => \output_regs[0][17]_i_1_n_0\,
      D => \channel_buf_reg[1]_1\(0),
      Q => \output_regs_reg[1][17]_0\(0),
      R => \^sr\(0)
    );
\output_regs_reg[1][10]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => s00_axi_aclk,
      CE => \output_regs[0][17]_i_1_n_0\,
      D => \channel_buf_reg[1]_1\(10),
      Q => \output_regs_reg[1][17]_0\(10),
      R => \^sr\(0)
    );
\output_regs_reg[1][11]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => s00_axi_aclk,
      CE => \output_regs[0][17]_i_1_n_0\,
      D => \channel_buf_reg[1]_1\(11),
      Q => \output_regs_reg[1][17]_0\(11),
      R => \^sr\(0)
    );
\output_regs_reg[1][12]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => s00_axi_aclk,
      CE => \output_regs[0][17]_i_1_n_0\,
      D => \channel_buf_reg[1]_1\(12),
      Q => \output_regs_reg[1][17]_0\(12),
      R => \^sr\(0)
    );
\output_regs_reg[1][13]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => s00_axi_aclk,
      CE => \output_regs[0][17]_i_1_n_0\,
      D => \channel_buf_reg[1]_1\(13),
      Q => \output_regs_reg[1][17]_0\(13),
      R => \^sr\(0)
    );
\output_regs_reg[1][14]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => s00_axi_aclk,
      CE => \output_regs[0][17]_i_1_n_0\,
      D => \channel_buf_reg[1]_1\(14),
      Q => \output_regs_reg[1][17]_0\(14),
      R => \^sr\(0)
    );
\output_regs_reg[1][15]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => s00_axi_aclk,
      CE => \output_regs[0][17]_i_1_n_0\,
      D => \channel_buf_reg[1]_1\(15),
      Q => \output_regs_reg[1][17]_0\(15),
      R => \^sr\(0)
    );
\output_regs_reg[1][16]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => s00_axi_aclk,
      CE => \output_regs[0][17]_i_1_n_0\,
      D => \channel_buf_reg[1]_1\(16),
      Q => \output_regs_reg[1][17]_0\(16),
      R => \^sr\(0)
    );
\output_regs_reg[1][17]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => s00_axi_aclk,
      CE => \output_regs[0][17]_i_1_n_0\,
      D => \channel_buf_reg[1]_1\(17),
      Q => \output_regs_reg[1][17]_0\(17),
      R => \^sr\(0)
    );
\output_regs_reg[1][1]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => s00_axi_aclk,
      CE => \output_regs[0][17]_i_1_n_0\,
      D => \channel_buf_reg[1]_1\(1),
      Q => \output_regs_reg[1][17]_0\(1),
      R => \^sr\(0)
    );
\output_regs_reg[1][2]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => s00_axi_aclk,
      CE => \output_regs[0][17]_i_1_n_0\,
      D => \channel_buf_reg[1]_1\(2),
      Q => \output_regs_reg[1][17]_0\(2),
      R => \^sr\(0)
    );
\output_regs_reg[1][3]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => s00_axi_aclk,
      CE => \output_regs[0][17]_i_1_n_0\,
      D => \channel_buf_reg[1]_1\(3),
      Q => \output_regs_reg[1][17]_0\(3),
      R => \^sr\(0)
    );
\output_regs_reg[1][4]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => s00_axi_aclk,
      CE => \output_regs[0][17]_i_1_n_0\,
      D => \channel_buf_reg[1]_1\(4),
      Q => \output_regs_reg[1][17]_0\(4),
      R => \^sr\(0)
    );
\output_regs_reg[1][5]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => s00_axi_aclk,
      CE => \output_regs[0][17]_i_1_n_0\,
      D => \channel_buf_reg[1]_1\(5),
      Q => \output_regs_reg[1][17]_0\(5),
      R => \^sr\(0)
    );
\output_regs_reg[1][6]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => s00_axi_aclk,
      CE => \output_regs[0][17]_i_1_n_0\,
      D => \channel_buf_reg[1]_1\(6),
      Q => \output_regs_reg[1][17]_0\(6),
      R => \^sr\(0)
    );
\output_regs_reg[1][7]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => s00_axi_aclk,
      CE => \output_regs[0][17]_i_1_n_0\,
      D => \channel_buf_reg[1]_1\(7),
      Q => \output_regs_reg[1][17]_0\(7),
      R => \^sr\(0)
    );
\output_regs_reg[1][8]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => s00_axi_aclk,
      CE => \output_regs[0][17]_i_1_n_0\,
      D => \channel_buf_reg[1]_1\(8),
      Q => \output_regs_reg[1][17]_0\(8),
      R => \^sr\(0)
    );
\output_regs_reg[1][9]\: unisim.vcomponents.FDRE
    generic map(
      ...
      C => s00_axi_aclk,
      CE => \output_regs[0][17]_i_1_n_0\,
      D => \channel_buf_reg[1]_1\(9),
      Q => \output_regs_reg[1][17]_0\(9),
      R => \^sr\(0)
    );
...
timer_of_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"10010000"
    )
        port map (
...
timer_of_i_2: unisim.vcomponents.LUT6
    generic map(
...
timer_of_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
timer_of_i_6: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_ppm_v1_0_S00_AXI is
  ...
  signal s_wdata1 : STD_LOGIC_VECTOR ( 17 downto 0 );
...
ppm_cap: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ppm_capture
     port map (
      Q(17 downto 0) => s_wdata1(17 downto 0),
      SR(0) => ppm_cap_n_0,
      \filter_ctr_reg[3]_0\ => \filter_ctr_reg[3]\,
      frame_valid => frame_valid,
      \output_regs_reg[1][17]_0\(17 downto 0) => s_wdata2(17 downto 0),
