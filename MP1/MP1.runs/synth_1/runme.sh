...
HD_PWD='C:/Users/ianrun75/Downloads/MP1new/MP1/MP1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mp1block_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mp1block_wrapper.tcl
