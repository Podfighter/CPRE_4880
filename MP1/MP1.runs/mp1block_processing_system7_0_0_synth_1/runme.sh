...
HD_PWD='C:/Users/ianrun75/Downloads/MP1new/MP1/MP1.runs/mp1block_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mp1block_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mp1block_processing_system7_0_0.tcl
