...
HD_PWD='C:/Users/ianrun75/Downloads/MP1new/MP1/MP1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mp1block_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mp1block_wrapper.tcl -notrace
